<div class="beta-content">
    ...
    <div class="beta-control-group <?php echo $form->hasErrors('email') ? 'error' : '';?>"">
        ...
        <div class="beta-controls">
            <?php echo CHtml::activeTextField($form, 'email', array('class'=>'beta-text'));?>
    ...
    <div class="beta-control-group <?php echo $form->hasErrors('username') ? 'error' : '';?>"">
        ...
        <div class="beta-controls">
            <?php echo CHtml::activeTextField($form, 'username', array('class'=>'beta-text'));?>
    ...
    <div class="beta-control-group">
        ...
        <div class="beta-controls">
            <?php echo CHtml::activePasswordField($form, 'password', array('class'=>'beta-text'));?>
        </div>
    </div>
    ...
    <div class="beta-control-group">
        ...
        <div class="beta-controls beta-agreement">
            <?php echo CHtml::activeCheckBox($form, 'agreement', array('id'=>'agreement'));?><label for="agreement"><?php echo t('agreement');?></label>
            <span class="beta-help-inline"><?php echo $form->getError('agreement');?></span>
        </div>
    </div>
    <div class="action-buttons">
        <?php echo CHtml::submitButton(t('user_signup'), array('class'=>'beta-btn btn-primary'));?>
    </div>
