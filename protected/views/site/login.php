<div class="beta-content">
    ...
    <div class="beta-control-group">
        ...
        <div class="beta-controls rememberme">
            <?php echo CHtml::activeCheckBox($form, 'rememberMe', array('id'=>'rememberme'));?><label for="rememberme"><?php echo t('autologin');?></label>
            <span class="beta-help-inline"><?php echo $form->getError('rememberMe');?></span>
        </div>
    </div>
    <div class="action-buttons">
        <?php echo CHtml::submitButton(t('user_login'), array('class'=>'beta-btn btn-primary'));?>
    </div>
